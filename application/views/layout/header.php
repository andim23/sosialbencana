...
<head>
    ...
    <link href="<?php echo base_url() ?>asset/front/css/style.css" rel="stylesheet" type="text/css" media="all" />
    <!-- //stylesheet -->
    <!-- online fonts -->
    ...
    <!-- //online fonts -->
    <!-- font-awesome-icons -->
    <link href="<?php echo base_url() ?>asset/front/css/font-awesome.css" type="text/css" rel="stylesheet">
    <!-- //font-awesome-icons -->
