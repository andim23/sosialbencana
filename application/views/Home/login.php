                ...
                ?>
					<div class="auth-body">
						...
						<div class="auth-register">
							...
							<div class="form-group">
								<!-- <label>Email address</label> -->
								<input type="email" name="email" class="form-control <?php echo form_error('email') ? 'is-invalid' : '' ?>"
						...
						<div class="auth-footer">
							<p><a href="<?php echo base_url('register'); ?>" class="mr-auto">Create Account</a> <a href="" class="ml-auto">Lupa
									Password</a> </p>
						</div>
					</div>
				</div>
