<script src="<?php echo base_url(); ?>asset/admin/scripts/jquery.min.js"></script>
<script src="<?php echo base_url(); ?>asset/admin/scripts/modernizr.min.js"></script>
<script src="<?php echo base_url(); ?>asset/admin/plugin/bootstrap/js/bootstrap.min.js"></script>
<script src="<?php echo base_url(); ?>asset/admin/plugin/mCustomScrollbar/jquery.mCustomScrollbar.concat.min.js"></script>
<script src="<?php echo base_url(); ?>asset/admin/plugin/nprogress/nprogress.js"></script>
<script src="<?php echo base_url(); ?>asset/admin/plugin/sweet-alert/sweetalert.min.js"></script>
<script src="<?php echo base_url(); ?>asset/admin/plugin/waves/waves.min.js"></script>
<!-- Morris Chart -->
